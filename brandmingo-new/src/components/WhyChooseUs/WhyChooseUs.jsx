...
// const SERVICES = [
//   { icon: <FiTarget size={22} />, label: "Performance Marketing" },
//   { icon: <FiShare2 size={22} />, label: "Social Media Marketing" },
//   { icon: <FiSearch size={22} />, label: "Search Engine Optimization" },
//   { icon: <FiEdit3 size={22} />, label: "Content Marketing" },
// ];
...
//               We combine strategy, creativity, and technology to deliver digital
