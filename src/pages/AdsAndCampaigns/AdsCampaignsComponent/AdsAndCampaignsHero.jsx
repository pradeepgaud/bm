  ...
  const features = [
    {
      ...
      desc: "Optimized ad strategies to drive maximum leads and conversions.",
    },
    {
      icon: "fas fa-mobile-alt",
      title: "Multi-Platform Reach",
      desc: "Run ads across Google, Meta, and multiple high-performing channels.",
    },
    {
      icon: "fas fa-search",
      title: "Data-Driven Optimization",
      desc: "Continuous tracking and improvements for better ROI and performance",
    },
    {
      icon: "fas fa-shield-alt",
      title: "Scalable Growth",
      desc: "Built to scale campaigns efficiently as your business grows.",
    },
  ];
          ...
          <div className="wd-hero-grid">
            ...
            <div className="wd-hero-content">
              <div className="wd-tagline">
                <i className="fas fa-bolt" /> OPTIMIZE. SCALE YOUR CAMPAIGNS.
              </div>
              ...
              <p className="wd-description">
                We don't just run ads — we create data-driven, high-converting
                campaigns that attract the right audience, generate quality
                leads, and turn clicks into real business growth.
              </p>
